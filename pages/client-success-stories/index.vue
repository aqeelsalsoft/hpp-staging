...
const postcategory = ref('Client Success Stories');
const { data, status, error, refresh, clear } = await useAsyncData(
    'blogs',
    () => $fetch(`${useRuntimeConfig().public.apiURL}/articles?page=1&type=1&postcategory=${postcategory.value}`),
    { initialCache: false }
);
...
useSeoMeta({
    title: "Client Success Stories | Packaging Solutions That Made Impact",
    meta: [
        { name: 'robots', content: `${useRuntimeConfig().public.siteURL === 'https://staging.halfpricepackaging.com/' ? 'noindex, nofollow' : 'index, follow'}` },
        { name: 'title', content: "Client Success Stories | Packaging Solutions That Made Impact" },
        { name: 'description', content: "Discover how Half Price Packaging empowered brands across industries with innovative, high-quality packaging solutions that stand out and deliver results." },
        { property: 'og:title', content: "Client Success Stories | Packaging Solutions That Made Impact" },
        { property: 'og:description', content: "Discover how Half Price Packaging empowered brands across industries with innovative, high-quality packaging solutions that stand out and deliver results." },
        ...
        { name: 'twitter:title', content: "Client Success Stories | Packaging Solutions That Made Impact" },
        { name: 'twitter:description', content: "Discover how Half Price Packaging empowered brands across industries with innovative, high-quality packaging solutions that stand out and deliver results." },
...
<template>
    <div class="hpp__blogListingPageWrapper bg-white">
        ...
        <div class="blog__listWrapper pt-[20px] md:pt-[50px] pb-[50px] md:pb-[100px]">
            <div class="md:container md:mx-auto px-[20px] md:px-[15px]">
                        ...
                        <div class="desc__wrap px-[30px] pt-[30px] pb-[30px]">
                            <div class="blog__metaWrap">
                                <ul class="flex gap-[20px] mb-[20px]">
                                    <li>
                                        <span
                                            class="font-description hidden whitespace-nowrap rounded-lg bg-slate-100 px-2 py-0.5 text-xs font-semibold leading-6 text-slate-700 lg:block">Client Success Stories</span>
                                    </li>
                                </ul>
                            </div>
