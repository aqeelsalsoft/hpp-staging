...
useSeoMeta({
  title: "Thank you sample kit | Half Price Packaging",
  meta: [
  { name: 'robots', content: `${useRuntimeConfig().public.siteURL === 'https://staging.halfpricepackaging.com/' ? 'noindex, nofollow' : 'index, follow'}` },
    { name: 'title', content: "Thank you sample kit | Half Price Packaging" },
    { property: 'og:title', content: "Thank you sample kit | Half Price Packaging" },
