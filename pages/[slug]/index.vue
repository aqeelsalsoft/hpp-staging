...
console.log("scriptTag::", data?.value?.category?.schema_script);
...
<template>
    <div class="hpp__catPageWrapper">
        <div class="hpp__categoryBannerWrapper pt-[20px] md:pt-[30px] bg-[#f9fafb]">
            <div class="md:container md:mx-auto px-[20px] md:px-[15px]">
                <div class="flex flex-wrap md:flex-no-wrap">
                    <div class="breadcrumbs__wrap mb-[20px] w-full px-[15px]">
                    ...
                    <div class="form__wrapper w-full md:w-[40%]">
                        ...
                        <ProductDetailBannerForm :title="data?.category?.sub_title"
        ...
        <div class="hpp__faqSectionWrapper py-[70px] bg-white">
            <div class="container mx-auto px-[15px]">
    ...
    C22.602,0.567,25.338,0.567,26.285,2.486z" />
                            ...
                            <div class="text-right basis-1/2">
                                <a href="https://www.google.com/search?q=half+price+packaging&sxsrf=ALiCzsagnxfrnR5uzV0qnBby6qK5JPHlfA%3A1667214393089&source=hp&ei=OaxfY9e8A6aJlwTW4oD4Dg&iflsig=AJiK0e8AAAAAY1-6STHTn6Ls6EZe00ThMT0OmDApSXrJ&ved=0ahUKEwiXvabNqYr7AhWmxIUKHVYxAO8Q4dUDCAg&uact=5&oq=half+price+packaging&gs_lcp=&sclient=gws-wiz"
                                    ...
                                    class="inline-block text-[12px] bg-blue-600 text-white px-6 py-2 rounded-[6px]">
