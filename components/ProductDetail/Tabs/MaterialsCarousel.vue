...
const materialsSlider = ref(null);
...
const initializeSlider = () => {
    if (props.isActive && materialsSlider.value) {
        keenSlider = new KeenSlider(materialsSlider.value, {
            // mode: "free-snap",
            loop: true,
            slides: {
                perView: 4,
...
const materials = [
    { thumbnail_link: "/images/products/material/white.jpg", item_name: "White" },
    { thumbnail_link: "/images/products/material/card.jpg", item_name: "Card Stock" },
    { thumbnail_link: "/images/products/material/corrugated.jpg", item_name: "Corrugated" },
    { thumbnail_link: "/images/products/material/foiling.jpg", item_name: "Foil" },
    { thumbnail_link: "/images/products/material/kraft.jpg", item_name: "Kraft" },
    { thumbnail_link: "/images/products/material/rigid.jpg", item_name: "Rigid" },
    { thumbnail_link: "/images/products/material/textured-linen.jpg", item_name: "Textured Linen" },
];
...
<template>
    ...
    <div class="relative overflow-hidden pb-[70px]">
        <div ref="materialsSlider" class="keen-slider !flex !overflow-visible overflow-y-hidden grow-0">
