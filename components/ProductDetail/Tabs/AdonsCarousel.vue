...
const initializeSlider = () => {
    if (props.isActive && adonsSlider.value) {
        keenSlider = new KeenSlider(adonsSlider.value, {
            // mode: "free-snap",
            loop: true,
            slides: {
                perView: 4,
...
const materials = [
    { thumbnail_link: "/images/products/adons/glass-lamination.jpg", item_name: "Glass Lamination" },
    { thumbnail_link: "/images/products/adons/holographic-foiling.jpg", item_name: "Holographic Foiling" },
    { thumbnail_link: "/images/products/adons/matte-lamination.jpg", item_name: "Matte Lamination" },
    { thumbnail_link: "/images/products/adons/silk-lamination.jpg", item_name: "Silk Lamination" },
    { thumbnail_link: "/images/products/adons/raised-uv.jpg", item_name: "Raised UV" },
    { thumbnail_link: "/images/products/adons/spot-uv.jpg", item_name: "Spot UV" },
];
...
<template>
    ...
    <div class="relative overflow-hidden pb-[70px]">
        <div ref="adonsSlider" class="keen-slider !flex !overflow-visible overflow-y-hidden grow-0">
