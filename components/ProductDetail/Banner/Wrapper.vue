...
<template>
    <div class="hpp__productBannerWrapper pt-[20px] md:pt-[30px] pb-[40px] md:pb-[30px] bg-[#f9fafb]">
        <div class="md:container md:mx-auto px-[20px] md:px-[15px]">
            <div class="flex flex-wrap">
                ...
                <div class="content__wrap w-full md:w-[45%] mb-8 md:mb-0 order-2 md:order-3">
