...
<template>
    <div class="hpp__instantFormWrapper" id="instantFormWrapper">
        <div class="flex flex-wrap items-center justify-center">
            <div class="md:text-center basis-full mb-[30px]">
                <h3 class="font-headings text-[#212529] text-[36px] leading-[40px] font-bold mb-5 md:mb-3">Get The Most Accurate Quotation</h3>
            ...
            <div class="p-[25px] w-full bg-white rounded-[32px]">
                <form id="hpp__instantPricesForm" @submit.prevent="onSubmit" class="mb-0">
                    <div class="flex flex-wrap ml-[-5px] mr-[-5px]">
                        ...
                        <div class="relative basis-[50%] md:basis-[20%] px-[5px] mb-[10px]">
                        ...
                        <div class="relative basis-[50%] md:basis-[20%] px-[5px] mb-[10px]">
                            ...
                            <input v-model="form.length" type="number" min="1" placeholder="Length" id="ipf-length"
                                class="font-description hover:cursor-pointer focus:cursor-auto rounded-lg w-full text-xs font-light transition-all resize-none outline-none border border-gray-200 hover:border-gray-300 py-[10px] px-[17px]" />
                        </div>
                        <div class="relative basis-[50%] md:basis-[20%] px-[5px] mb-[10px]">
                            <label for="ipf-width" class="sr-only">Width</label>
                            <input v-model="form.width" type="number" min="1" placeholder="Width" id="ipf-width"
                                class="font-description hover:cursor-pointer focus:cursor-auto rounded-lg w-full text-xs font-light transition-all resize-none outline-none border border-gray-200 hover:border-gray-300 py-[10px] px-[17px]" />
                        </div>
                        <div class="relative basis-[50%] md:basis-[20%] px-[5px] mb-[10px]">
                            <label for="ipf-height" class="sr-only">Height</label>
                            <input v-model="form.height" type="number" min="1" placeholder="Height" id="ipf-height"
                                class="font-description hover:cursor-pointer focus:cursor-auto rounded-lg w-full text-xs font-light transition-all resize-none outline-none border border-gray-200 hover:border-gray-300 py-[10px] px-[17px]" />
                        </div>
                        <div class="relative basis-[50%] md:basis-[20%] px-[5px] mb-[10px]">
                        ...
                        <div class="relative basis-[50%] md:basis-[20%] px-[5px] mb-[10px]">
                            ...
                            <input type="text" v-model="form.quantity" @input="validateQuantity()" required placeholder="Quantity (min: 200)*" id="ipf-quantity"
                                class="font-description hover:cursor-pointer focus:cursor-auto rounded-lg w-full text-xs font-light transition-all resize-none outline-none border border-gray-200 hover:border-gray-300 py-[10px] px-[17px]" />
                        ...
                        <div class="relative basis-[50%] md:basis-[20%] px-[5px] mb-[10px]">
                            ...
                            <select v-model="form.printing_sides" name="dimension-unit" id="ipf-printing-sides"
                                class="font-description hover:cursor-pointer focus:cursor-auto rounded-lg w-full text-xs font-light transition-all resize-none outline-none border border-gray-200 hover:border-gray-300 py-[10px] px-[17px]">
                        ...
                        <div class="relative basis-[50%] md:basis-[20%] px-[5px] mb-[10px]">
                            ...
                            <select v-model="form.card_thickness" name="card-thickness" id="ipf-card-thickness"
                                class="font-description hover:cursor-pointer focus:cursor-auto rounded-lg w-full text-xs font-light transition-all resize-none outline-none border border-gray-200 hover:border-gray-300 py-[10px] px-[17px]">
                        ...
                        <div class="relative basis-[50%] md:basis-[20%] px-[5px] mb-[10px]">
                            ...
                            <select v-model="form.coating_lamination" name="coating-lamination" id="ipf-coating-lamination"
                                class="font-description hover:cursor-pointer focus:cursor-auto rounded-lg w-full text-xs font-light transition-all resize-none outline-none border border-gray-200 hover:border-gray-300 py-[10px] px-[17px]">
                        ...
                        <div class="relative basis-[100%] md:basis-[60%] px-[5px] mb-[20px]">
                            <textarea
                        ...
                        <div class="relative basis-[100%] md:basis-[40%] upload-container flex items-center justify-between w-full self-center px-[10px] mb-[20px]">
                            <div class="drop-area w-fit rounded-md transition-all text-center">
                                ...
                                <input name="file"  @change="handleFileChange"  type="file" id="file-input" accept="image/*" class="hidden" />
                                <small
                                    class="font-description block px-[10px] text-[11px] text-gray-500/50 font-medium text-left">File(s)
                                    size limit is 20MB.</small>
                                <!-- Image upload input -->
                                <div class="preview-container rounded-lg items-center gap-2" v-if="form.file">
                                    <div class="preview-image w-16 h-16 bg-cover bg-center rounded-md"></div>
                                    <div>
                                        <div class="flex items-baseline flex-col mb-2">
                                            <p class="_description text-black/50 text-xs">File name: {{ form.file.name }}</p>
                                            <span
